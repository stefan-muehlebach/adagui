...
var (
	PicoPalette = []colors.RGBA{
		{R: 0x00, G: 0x00, B: 0x00, A: 0xFF},
		{R: 0x1d, G: 0x2b, B: 0x53, A: 0xFF},
		{R: 0x7e, G: 0x25, B: 0x53, A: 0xFF},
		{R: 0x00, G: 0x87, B: 0x51, A: 0xFF},
		...
		{R: 0xff, G: 0xa3, B: 0x00, A: 0xFF},
		{R: 0xff, G: 0xff, B: 0x27, A: 0xFF},
		{R: 0x00, G: 0xe7, B: 0x56, A: 0xFF},
		{R: 0x29, G: 0xad, B: 0xff, A: 0xFF},
		{R: 0x83, G: 0x76, B: 0x9c, A: 0xFF},
		{R: 0xff, G: 0x77, B: 0xa8, A: 0xFF},
		{R: 0xff, G: 0xcc, B: 0xaa, A: 0xFF},
		{R: 0x29, G: 0x18, B: 0x14, A: 0xFF},
		{R: 0x11, G: 0x1d, B: 0x35, A: 0xFF},
		{R: 0x42, G: 0x21, B: 0x36, A: 0xFF},
		{R: 0x12, G: 0x53, B: 0x59, A: 0xFF},
		{R: 0x74, G: 0x2f, B: 0x29, A: 0xFF},
		{R: 0x49, G: 0x33, B: 0x3b, A: 0xFF},
		{R: 0xa2, G: 0x88, B: 0x79, A: 0xFF},
		{R: 0xf3, G: 0xef, B: 0x7d, A: 0xFF},
		{R: 0xbe, G: 0x12, B: 0x50, A: 0xFF},
		{R: 0xff, G: 0x6c, B: 0x24, A: 0xFF},
		{R: 0xa8, G: 0xe7, B: 0x2e, A: 0xFF},
		{R: 0x00, G: 0xb5, B: 0x43, A: 0xFF},
		{R: 0x06, G: 0x5a, B: 0xb5, A: 0xFF},
		{R: 0x75, G: 0x46, B: 0x65, A: 0xFF},
		{R: 0xff, G: 0x6e, B: 0x59, A: 0xFF},
		{R: 0xff, G: 0x9d, B: 0x81, A: 0xFF},
	}
)
...
func NewColorPicker(orient adagui.Orientation, numColsRows int) *ColorPicker {
	...
	c.orient = orient
	c.colorList = make([][]colors.RGBA, numColsRows)
...
func (c *ColorPicker) SetColors(colRowIdx int, cl []colors.RGBA) {
	c.colorList[colRowIdx] = make([]colors.RGBA, len(cl))
...
func (c *ColorPicker) Color() colors.RGBA {
	return c.value.Get().(colors.RGBA)
}

func (c *ColorPicker) SetColor(col colors.RGBA) {
	ledColor := col
...
func (g *LedGrid) OnInputEvent(evt touch.Event) {
	...
	case touch.TypeDrag:
		...
		newColor := g.DrawColor.Mix(oldColor, colors.Blend)
...
func main() {
	...
	screen = adagui.NewScreen(adatft.Rotate270)
	...
	colorPicker.SetColors(0, PicoPalette[:16])
	colorPicker.SetColors(1, PicoPalette[16:32])
	colorValue.AddCallback(func(data binding.DataItem) {
		if data == nil {
			return
		}
		ledPanel.DrawColor = data.(binding.Untyped).Get().(colors.RGBA)
	})
	colorPicker.SetColor(PicoPalette[0])
	...
	*/
	...
	btnQuit.SetOnTap(func(evt touch.Event) {
		ledPanel.Clear(colors.RGBA{0, 0, 0, 0xff})
