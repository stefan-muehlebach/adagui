...
func ScrolledFontPanel() adagui.Node {
	...
	for i, fontName = range fontList[:16] {
...
func buildFirstTab() adagui.Node {
	...
	txtBtn03.SetPushedBorderColor(color.Gold)
	grpBtn.Add(txtBtn01, txtBtn02, txtBtn03, adagui.NewSpacer())
	...
	grpSlider.Add(sld01, sld02, scr01, scr02)

	return grpMain
}

func buildSecondTab() adagui.Node {
	var iconList []*adagui.IconButton
...
func widgetFlex() adagui.Node {
	...
	menu.AddTab("Samples", buildFirstTab())
	menu.AddTab("(Same)", buildSecondTab())
